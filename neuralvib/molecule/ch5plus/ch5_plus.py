...
class CH5Plus(MoleculeBase):
    ...
    def __init__(
        ...
        """
        self.particles: tuple = ("C", "H", "H", "H", "H", "H")
    ...
    def trans_normal2mwcd_matrix(self) -> np.ndarray:
        ...
        """
        if self._select_potential == "J.Phys.Chem.A2021,125,5849-5859":
            trans_normal2mwcd_matrix_nnpes = (
                "./neuralvib/molecule/"
                "ch5plus/McCoy_NN_PES/trans_normal2mwcd_matrix_ch5p_nn_pes"
            )
            with open(trans_normal2mwcd_matrix_nnpes, "rb") as f:
                _trans_normal2mwcd_matrix = pickle.load(f)
        elif (
            self._select_potential == "J.Phys.Chem.A2006,110,1569-1574"
            or self._select_potential
            == "External.J.Phys.Chem.A2006,110,1569-1574.Joblib"
        ):
            trans_n2mwcd_matrix_jbb = (
                "./neuralvib/molecule/ch5plus/JBB_Full_PES/"
                "trans_normal2mwcd_matrix_ch5p_nnpes_JBB_equilibrium_conf"
            )
            with open(trans_n2mwcd_matrix_jbb, "rb") as f:
                _trans_normal2mwcd_matrix = pickle.load(f)
        elif (
            self._select_potential == "PySCF.HF.pure"
            or self._select_potential == "PySCF.HF.io"
            ...
            trans_n2mwcd_matrix_pyscf = (
                "./neuralvib/molecule/ch5plus/pyscf_PES/"
                "trans_normal2mwcd_matrix_ch5p_nnpes"
            )
            with open(trans_n2mwcd_matrix_pyscf, "rb") as f:
                _trans_normal2mwcd_matrix = pickle.load(f)
    ...
    def w_indices(self) -> np.ndarray:
        ...
        cm2au = _convert_inverse_cm_to_hartree(1.0)
        _w_indices = w_indices_cm_inv * cm2au
    ...
    def convert_config_cartesian_to_pes_origin_func_input(
        ...
        Args:
            cartesian_coors: (num_of_particles,dim,) the
